        ...
        child: Container(
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 30,),
              MyTextField(hasLabel: true, controller: fullname.value, label: "Full Name",),
              SizedBox(height: 10,),
              MyTextField(hasLabel: true, controller: username.value, label: "Username",),
              SizedBox(height: 10,),
              MyTextField(hasLabel: true, controller: email.value, label: "Email",),
              SizedBox(height: 10,),
